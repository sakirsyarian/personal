...
const posts = [
  {id: 1, title: "Understanding React Hooks", date: "2023-06-15", views: 1200},
  {id: 2, title: "Mastering JavaScript", date: "2023-07-02", views: 980},
  {id: 3, title: "Next.js App Router Deep Dive", date: "2023-07-20", views: 1500},
];
  ...
  <section class="py-10">
    <div class="container mx-auto max-w-screen-md px-4">
      ...
      <div class="space-y-4 mb-6">
        <p>
          Yuk, gabung bareng <b>200+ developer</b> yang tiap minggu dapetin insight keren soal JavaScript, framework terbaru, plus tips pengembangan yang super praktis!
        </p>
        <p>Mulai perjalananmu jadi developer yang lebih jago dengan <b>tutorial seru, tren teknologi terbaru, </b>
          dan <b> wawasan eksklusif</b> yang cuma ada buat subscriber.</p>
        <p>Oh ya, sebagai bonus, kamu juga bakal dapet e-book gratis <b>"JavaScript Essentials for Modern Developers"</b>
          biar makin mantap nguasain dasar-dasarnya. </p>
      </div>
    ...
    <div class="container mx-auto max-w-screen-md px-4">
      ...
      <div class="flex flex-wrap gap-6">
        ...
        <article class="flex p-4 items-center rounded-lg border transition-shadow hover:shadow-lg">
          <img src="/ebook/js.webp" alt="ebook javascript" width="120">
          <NuxtLink to="https://jagojs.my.id">
            <div class="px-3 pb-2 space-y-2">
              <h3 class="mb-4 text-lg font-semibold">Beginner JavaScript</h3>
              <p>By Ahmad Sarian</p>
              <p>Belajar dari nol sampai paham total, tanpa drama coding yang bikin pusing kepala. Cocok banget buat kamu yang mau jadi jago JavaScript!</p>
            </div>
          </NuxtLink>
        </article>
